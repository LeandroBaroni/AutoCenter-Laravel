        ...
        <div class="main-wrapper split-content">
            ...
            <section class="about__content">
                <section class="about__history">
                    ...
                    <p><strong>Missão: </strong>Eheu, barbatus consilium! Rumor emeritis mensa est. Sunt lunaes imitari talis, flavum eraes. Sunt lumenes carpseris talis, superbus capioes. </p>
                    <p><strong>Visão: </strong>Naviss sunt classiss de altus racana. Cum frondator manducare, omnes cottaes quaestio festus, salvus adiuratores. </p>
                    <p><strong>Valores: </strong>Cur axona nocere? Cum species favere, omnes solitudoes perdere bi-color, peritus vortexes. Est albus silva, cesaris.</p>
                </section>
